...
## Como usar
- Comece lendo o [guia rápido](#) para saber sobre instalação, configurações, uso, passos obrigatórios e 
  personalização, tanto do Django Admin quanto de Django Forms.
- Leia como [contribuir](#) no desenvolvimento. Lembre-se, é uma licença MIT, ou seja, use como quiser.
