...
Accordion,BRAccordion,BRAvatar,BRBreadcrumb,BRCard,BRCheckbox,BRCookiebar,BRDateTimePicker,BRFooter,BRHeader,BRInput,BRItem,BRList,BRMenu,BRMessage,BRModal,BRNotification,BRPagination,BRScrim,BRSelect,BRTab,BRTable,BRTag,BRTextarea,BRTooltip,BRUpload,BRWizard,Checkgroup,Collapse,Dropdown,Globals,Scrim,Swipe,}
const globals=new Globals()
globals.initInstanceAll()
const behavior=new Behavior()
behavior.initInstanceAll()
Accordion,Checkgroup,BRAccordion,Dropdown,BRBreadcrumb,BRCarousel,Collapse,BRCard,BRCheckbox,BRCookiebar,BRDateTimePicker,BRFooter,BRHeader,BRInput,BRItem,BRList,BRMenu,BRAlert,BRModal,BRNotification,BRPagination,BRScrim,BRSelect,BRStep,BRTab,BRTable,BRTag,BRTextarea,BRTooltip,BRUpload,BRWizard,Globals,Tooltip,globals,behavior,Swipe,Scrim,};