...
O [DS Gov.BR](https://www.gov.br/ds/home) é o design system oficial do Governo Federal Brasileiro,
criado para padronizar a experiência do usuário em todos os portais e sistemas governamentais.

#### Links oficiais do DSGovBR

- 🏠 [Site Oficial](https://www.gov.br/ds/home)
- 📚 [Visão geral](https://www.gov.br/ds/fundamentos-visuais/visao-geral)
- 🎨 [Introdução](https://www.gov.br/ds/fundamentos-visuais/introducao)
...
- Comece lendo o [guia rápido](https://kelsoncm.github.io/django-admintheme-dsgovbr/start-guide/) para saber sobre
  instalação, configurações, uso, passos obrigatórios e personalização, tanto do Django Admin quanto de Django Forms.
- Leia como [contribuir](https://kelsoncm.github.io/django-admintheme-dsgovbr/contribute/) no desenvolvimento.
- Lembre-se, é uma licença MIT, ou seja, use como quiser.
